...
public class UpdatesSettingsTv extends UpdatesSettings {
    ...
    private String createSysinfoMessage() {
        ...
        String sysinfomessage = getString(R.string.sysinfo_device) + " " + Utils.getDeviceType(getBaseContext()) +
                "                            " + getString(R.string.sysinfo_running) + " "
                + Utils.getInstalledVersion(getBaseContext()) + "\n" + getString(R.string.sysinfo_update_channel)
                + " " + Utils.getUpdateType(getBaseContext()) + "    " + getString(R.string.sysinfo_last_check) + " "
                + date + " " + time;
